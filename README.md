# Cyberpunk RED Mode for Helix

Полноценная реализация пошагового боя Cyberpunk RED внутри редактора Helix через `C`-меню. Включает все системы оригинальной TTRPG, кастомный генератор персонажей и уникальный интерфейс в стиле киберпанк.

![Пример интерфейса](preview_01.png)

## Особенности
- 🎮 **Полноценный пошаговый бой** с системой инициативы
![Пример боя](preview_02.png)
...
![Пример дайсов](preview_04.png)

## Установка
1. Склонируйте репозиторий в `~/garrysmod/gamemodes/`
2. Не заабудьте установить Helix и аддоны из коллекции.
