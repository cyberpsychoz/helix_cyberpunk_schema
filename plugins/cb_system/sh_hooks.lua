...
local deathMessages = {
    ...
    "Дети, не берите шприцы с улицы, а то закончите как %s. Земля ему пухом.",
    "%s прожил хорошую жизнь, прощай друг.",
    "%s прожил ужасную жизнь, прощай мудила.",
    "%s прожил счастливую жизнь, кто-то будет скорбить по нему.",
    ...
    "А-а! Помогите! Тут Спайдер Мёрфи убили, а не это просто %s...",
