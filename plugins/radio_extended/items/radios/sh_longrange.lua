ITEM.name = "Длинноволновой радиопередатчик"
ITEM.description = "Это устройство способно вещать на большие расстояния по одной частоте.\nСостояние: %s%s."
ITEM.category = "Radio"
ITEM.model = "models/lt_c/sci_fi/headset_2.mdl"
ITEM.longrange = true
