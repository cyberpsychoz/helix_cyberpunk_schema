...
ITEM.name = "Гибридный передатчик"
ITEM.description = "Гибридный симплексный/дуплексный передатчик, работающий по принципу Walkie-Talkie%s.\nСостояние: %s%s."
ITEM.category = "Radio"
ITEM.model = "models/lt_c/sci_fi/headset.mdl"
ITEM.hybrid = true
