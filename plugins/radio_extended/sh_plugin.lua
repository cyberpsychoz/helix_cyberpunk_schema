...
if (CLIENT) then
	...
	netstream.Hook("Channel", function(names)
		...
		local quer = Derma_Query("Щелкните левой кнопкой мыши, чтобы выбрать свой канал\nЩелкните правой кнопкой мыши, чтобы изменить канал", "Выбор канала",
		...
		function ch1panel:DoRightClick()
			Derma_StringRequest("Название канала", "Каким бы вы хотели видеть новое название?\nВведите пробел, чтобы вернуть название канала к значению по умолчанию", names[1], function(text)
				if text == " " then
					setTheName("1","CH1")
				else
					setTheName("1",text)
		...
		function ch2panel:DoRightClick()
			Derma_StringRequest("Название канала", "Каким бы вы хотели видеть новое название?\nВведите пробел, чтобы вернуть название канала к значению по умолчанию", names[2], function(text)
				if text == " " then
					setTheName("2","CH2")
				else
					setTheName("2",text)
		...
		function ch3panel:DoRightClick()
			Derma_StringRequest("Название канала", "Каким бы вы хотели видеть новое название?\nВведите пробел, чтобы вернуть название канала к значению по умолчанию", names[3], function(text)
				if text == " " then
					setTheName("3","CH3")
				else
					setTheName("3",text)
		...
		function ch4panel:DoRightClick()
			Derma_StringRequest("Название канала", "Каким бы вы хотели видеть новое название?\nВведите пробел, чтобы вернуть название канала к значению по умолчанию", names[4], function(text)
				if text == " " then
					setTheName("4","CH4")
				else
					setTheName("4",text)
