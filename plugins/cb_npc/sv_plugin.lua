...
local MSPlaces = {
   ...
   {"ix_booster_med", Vector(1588.7805175781, -1879.1166992188, -31.005353927612), 1, 1},
   {"ix_booster_med", Vector(513.02587890625, -991.4345703125, -103.00576019287), 1, 1},
   {"ix_booster_med", Vector(2361.0048828125, -1868.7250976562, -31.005350112915), 1, 1},
   ...
   {"ix_booster_med", Vector(-6413.7607421875, -173.96875, -1262.96875), 1, 1},
   {"ix_booster_med", Vector(-6336.3149414062, -998.40270996094, -1277.21875), 1, 1},
   {"ix_fixer_low", Vector(-6862.7587890625, -1853.3889160156, -1277.96875), 1, 1},

   --БАР
   {"ix_fixer_low", Vector(5.6220879554749, -23.999099731445, -52.96875), 1, 1},
   {"ix_citizen", Vector(77.926620483398, 432.6321105957, -52.96875), 1, 1},

   --ВТОРОЙ ДИСТРИКТ
   {"ix_citizen", Vector(-889.75610351563, -212.51184082031, -55.96875), 1, 1},
   {"ix_citizen", Vector(-5101.7900390625, -1433.5230712891, -57.96875), 1, 1},
   {"ix_fixer_low", Vector(-5807.9995117188, 105.69860076904, -55.96875), 1, 1},
...
timer.Create("arist_mobs", 600, 0, MobSpawn)
