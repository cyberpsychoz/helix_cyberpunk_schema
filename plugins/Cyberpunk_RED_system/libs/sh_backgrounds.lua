...
function ix.backgrounds.LoadFromDir(directory)
	for _, v in ipairs(file.Find(directory.."/*.lua", "LUA")) do
		...
		BACKGROUND = ix.backgrounds.list[niceName] or {}
			...
			BACKGROUND.name = BACKGROUND.name or "Неизвестен"
			BACKGROUND.description = BACKGROUND.description or "Описание недоступно."
...
do
	ix.char.RegisterVar("background", {   
		...
		OnDisplay = function(self, container, payload)
			...
			bgpictureIcon:SetImage( "icons/2_20.jpg" )
