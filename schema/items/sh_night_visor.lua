ITEM.name = "Модуль ПНВ старого образца"
ITEM.description = "Очень старый ПНВ, интересно откуда он тут вообще мог взяться? Наверняка кто-то украл его с военных складов."
