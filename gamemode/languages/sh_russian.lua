...
LANGUAGE = {
	...
	introTextOne = "D-URKA представляет",
	...
	helpFlags = "Флаги с зеленым фоном обозначают доступные этой оболочке флаги.",
	...
	chatTyping = "Печатает...",
	chatTalking = "Формирует мысль...",
	chatYelling = "Набирает воздух в лёгкие...",
	chatWhispering = "Переходит на шёпот...",
	chatPerforming = "Готовится...",
	...
	create = "Создать",
	update = "Обновить",
	load = "Загрузить оболочку",
	loadTitle = "Загрузить оболочку.",
	leave = "Убежать",
	leaveTip = "Сбежать в страхе.",
	["return"] = "Вернуться",
	returnTip = "Вернуться в предыдущее меню.",
	proceed = "Продолжить",
	faction = "Принадлежность",
	skills = "Навыки",
	traits = "Особенности",
	choose = "Выбрать",
	chooseFaction = "Выберите принадлежность",
	chooseDescription = "Внешние факторы оболочки",
	chooseSkills = "Характеристики оболочки",
	name = "Наименование",
	...
	Strength = "Сила",
	charInfo = "Информация об оболочке",
	charCreated = "Оболочка успешно произведена.",
	charCreateTip = "Заполните поля ниже и нажмите 'Создать' чтобы создать оболочку.",
	...
	maxCharacters = "Достигнут лимит созданных оболочек!",
	player = "Игрок",
	finish = "Создать",
	finishTip = "Закончить создание оболочки.",
	needModel = "Выберите одну из моделей!",
	creating = "Оболочка создается...",
	unknownError = "Произошла неизвестная ошибка!",
	areYouSure = "Вы уверены?",
	delete = "Удалить",
	deleteConfirm = "Эта оболочка будет утилизирована!",
	deleteComplete = "%s был утилизирован.",
	no = "Нет",
	yes = "Да",
	close = "Закрыть",
	save = "Сохранить",
	...
	cChangeFaction = "%s перенес оболочку %s во фракцию %s ",
	playerCharBelonging = "Этот предмет принадлежит другой оболочке!",
	...
	noWhitelist = "У вас нет вайтлиста для этой оболочки!",
	...
	itemOwned = "Вы не можете взаимодействовать с предметом, который принадлежит другому вашей оболочке!",
	help = "Помощь",
	commands = "Команды",
	...
	descChanged = "Описание вашей оболочки успешно изменено.",
	noOwner = "Неверный владелец!",
	invalidItem = "Вы указали неверный предмет!",
	invalidInventory = "Вы указали неверный инвентарь!",
	home = "Домой",
	charKick = "%s выгнал оболочку %s.",
	charBan = "%s утилизировал оболочку %s.",
	charBanned = "Эта оболочка утилизирована.",
	charBannedTemp = "Эта оболочка временно находится вне доступа.",
	...
	charSearching = "Вы уже ищите другую оболочку!",
	charUnBan = "%s вернул оболочку %s.",
	charNotBanned = "Эта оболочка не утилизирована!",
	...
	youreDead = "КРИТИЧЕСКОЕ ПОВРЕЖДЕНИЕ",
	injMajor = "Очень сильно ранен",
	injLittle = "Слегка ранен",
	chgName = "Сменить имя",
	chgNameDesc = "Введите новое имя оболочки.",
	...
	noRecog = "Вы не знаете эту оболочку.",
	curTime = "Время: %s.",
	...
	chooseTip = "Выберите оболочку, чтобы начать играть.",
	deleteTip = "Удалить эту оболочку.",
	...
	respawning = "Попытка восстановить целостность конструкта...",
	...
	optdAlwaysShowBars = "Отображает состояние оболочки в левом верхнем углу на постоянной основе.",
	...
	optdThirdpersonClassic = "Управлять взглядом вашей оболочки с помощью мыши.",
	...
	optdThirdpersonHorizontal = "Расположение камеры влево или вправо от оболочки.",
	optThirdpersonDistance = "Расстояние камеры",
	optdThirdpersonDistance = "Как далеко располагается камера от оболочки.",
	...
	cmdPM = "Отправить личное сообщение выбранной оболочке.",
	...
	cmdCharKick = "Кикнуть выбранную оболочку.",
	cmdCharBan = "Ограничить игроку доступ к выбранной оболочке.",
	cmdCharUnban = "Снимает ограничение на игру за выбранную оболочку.",
	cmdGiveMoney = "Передать сумму денег оболочке, на которую вы смотрите.",
	cmdCharSetMoney = "Изменить сумму денег у оболочки на указанную.",
	cmdDropMoney = "Положить определенную сумму денег в хранилище на которое вы смотрите.",
	cmdPlyWhitelist = "Выдать доступ игроку к созданию оболочки в указанной фракции",
	cmdCharGetUp = "Попытаться встать после падения.",
	cmdPlyUnwhitelist = "Забрать доступ у игрока к созданию оболочки в указанной фракции.",
	cmdCharFallOver = "Расслабиться и упасть на землю.",
	cmdBecomeClass = "Взять выбранный класс в вашей текущей фракции.",
	cmdCharDesc = "Установить физическое описание вашей оболочки.",
	cmdCharDescTitle = "Физическое описание",
	cmdCharDescDescription = "Введите физическое описание оболочки.",
	cmdPlyTransfer = "Перевести выбранную оболочку в указанную фракцию.",
	...
	cmdMapSceneAdd = "Добавить кинематографичную камеру, в меню выбора оболочки.",
	cmdMapSceneRemove = "Убрать кинематографичную камеру, в меню выбора оболочки.",
