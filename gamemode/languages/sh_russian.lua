...
LANGUAGE = {
	...
	name = "Наименование",
	description = "Описание внещности",
	model = "Внешность",
	attributes = "Атрибуты",
	...
	home = "Домой",
	charKick = "%s кикнул оболочку %s.",
	charBan = "%s забанил оболочку %s.",
	charBanned = "Эта оболочка забанена.",
	charBannedTemp = "Эта оболочка временно забанена.",
	...
	charUnBan = "%s разбанил оболочку %s.",
	charNotBanned = "Эта оболочка не забанена!",
	...
	youreDead = "КРИТИЧЕСКОЕ РАНЕНИЕ ОБОЛОЧКИ",
